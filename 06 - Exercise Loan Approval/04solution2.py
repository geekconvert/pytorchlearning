...
# to check whether "credit_score" has any impact on loan_status, we can just remove it and make "9" below to "8" as columns are reduced and see the accuracy difference
...
model = nn.Sequential(nn.Linear(9, 32), nn.ReLU(),nn.Linear(32, 16), nn.ReLU(),nn.Linear(16, 1));
