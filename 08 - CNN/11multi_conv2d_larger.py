...
model = nn.Sequential(
    ...
    nn.Flatten(),
    # the step from this many inputs to just 100 outputs and then from 100 outputs to ten final outputs could be a bit drastic. So we add an additional layer with 1000 neurons in between
    nn.Sequential(
...
with torch.no_grad():
    ...
    print("Accuracy on test data:", accurate / total)