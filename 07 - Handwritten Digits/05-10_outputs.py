...
# Based on the output you can observer that this is not generating ten columns, but only as many columns as are needed.
print(F.one_hot(torch.tensor([1,2,3])))
print(F.one_hot(torch.tensor([1,2,3, 8])))

# this will generate ten columns
print(F.one_hot(torch.tensor([1,2,3]), num_classes=10))
