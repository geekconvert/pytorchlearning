...
#This loss function already ships with a built in softmax calculation.
...
with torch.no_grad():
    ...
    for X, y in test_dataloader:
        ...
        # Here in this case I want the softmax to be applied row wise. So I need to set the dim parameter here to one.
        outputs = nn.functional.softmax(model(X), dim=1)

        # # This proves that the softmax is working correctly as sum of probabilities for each row is 1.
